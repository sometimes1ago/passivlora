...
{
    public partial class PlantCare : Form
    {
        public PlantCare()
        {
            InitializeComponent();
        ...
        private void PlantCare_Load(object sender, EventArgs e)
        {
            ...
            DB.GetAllProdNames("Уход за растениями");
            ...
            ProdNames.SelectedItem = "Удобрения";
        }
