...
{
    public partial class Pots : Form
    {
        public Pots()
        {
            InitializeComponent();
        ...
        private void Pots_Load(object sender, EventArgs e)
        {
            ...
            PtData.DataSource = DB.GetAllProds("Горшки", SortOpt, OrderOpt, PriceFrom, PriceTo);
            ...
            ProdNames.SelectedItem = "Маленький";
        }
        ...
        private void Pots_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
