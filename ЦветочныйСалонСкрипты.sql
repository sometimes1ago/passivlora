...
as
	select Товары.ID_Товара, Товары.Наименование, Типы_Товаров.Наименование, Товары.Длина_см, Товары.Ширина_см, Товары.Высота_см, Товары.Стоимость
...
select * from GetAllClients where Логин = '244'
