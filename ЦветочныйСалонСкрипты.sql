...
insert into Заказы(Товар, Количество, Способ_доставки,Адрес_доставки, Дата_заказа, Сумма_заказа, Статус_заказа, Код_выдачи)
values ('1','1','Курьером','Карла-маркса-250',getdate(),'1500','Новый','xj0')
go
