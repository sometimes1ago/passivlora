...
as
	begin
		select Заказы.ID_Заказа as Номер_заказа, Товары.Наименование as Товар, 
		Типы_Товаров.Наименование as Тип_товара, 
		Клиенты.Фамилия, Клиенты.Имя, Клиенты.Телефон, Заказы.Сумма_заказа, Заказы.Адрес_доставки, 
		Заказы.Дата_заказа, Заказы.Статус_заказа, Заказы.Код_выдачи
...
Сумма_заказа, Адрес_доставки, Дата_заказа, Статус_заказа, Код_выдачи)
as
